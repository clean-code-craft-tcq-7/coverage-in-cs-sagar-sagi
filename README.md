...
- Enter Reflections: This workflow fails till you replace it with your impressions.
...
Improve the testing, Readablity of the code and implement stratergy patterns
